function [u_opt, U_f,U_r,min_Pwr, flag] = EVFmincon_Non_overshooting(req_data, current_timestep,SOC, v_curr,Torque_demand, EMspeed, prev_u)
...
function [c,ceq]=EVConstraintFCN(SOC,u,N,Ts,veh,v_k,v_ref,info)
    ...
    num_of_constraints_per_stage=7;
    ...
    for i=1:N
        ...
        % Non-overshooting constraints
        c((num_of_constraints_per_stage*(i-1))+7)=v_ref(i)-v_k;
